...
class ScenarioWindow : GuiDraggable {
	...
	ScenarioWindow() {
		...
		//          Window
		//
		// This doesn't happen. Nothing ever seems to make the speaker boxes
		// visible?????????????
		//
		super(null, recti(0,0,550+SPEAKER_BOX_SIZE+SPEAKER_BOX_SIZE,280));
		@bg = GuiBackgroundPanel(this, Alignment(Left, Top, Right, Bottom));
		bg.titleColor = Color(0xb3fe00ff);
		bg.titleStyle = SS_FullTitle;

		@leftSpeakerBox = GuiBackgroundPanel(this, Alignment(Left-SPEAKER_BOX_SIZE, Top, Left, Top-SPEAKER_BOX_SIZE));
		leftSpeakerBox.pictureColor = Color(0xffffffff);

		@rightSpeakerBox = GuiBackgroundPanel(this, Alignment(Right, Top, Right+SPEAKER_BOX_SIZE, Top-SPEAKER_BOX_SIZE));
