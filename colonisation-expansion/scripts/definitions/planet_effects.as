...
#section server
	void enable(Object& cur, any@ data) const override {
		// [[ MODIFY BASE GAME START ]]
		// Terraform To now remebers all the resources removed
		// from the planet automatically
		// [[ MODIFY BASE GAME END ]]
	...
	void disable(Object& cur, any@ data) const override {
		// [[ MODIFY BASE GAME START ]]
		// Terraform Back now restores the remembered resources
		// if they've not been removed by another Terraform first
		// [[ MODIFY BASE GAME END ]]
		cur.terraformBack(resource.integer);
	}

	// [[ MODIFY BASE GAME START ]]
	// No longer need to save the primary resource of this planet
	void save(any@ data, SaveFile& file) const override {
	}
