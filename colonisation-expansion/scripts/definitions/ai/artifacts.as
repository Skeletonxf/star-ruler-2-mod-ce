...
class AsCreatedResource : ArtifactAI {
	...
	// Replacing water with comet water is not something the AI should be allowed
	// to do, because then it will happily 'replace' more water with comet water
	// on the same planet. Hence the default should be false.
	Argument replaces_existing(AT_Boolean, "False", doc="Whether this can be used to replace an existing import of that type or not.");
