...
class GamePage : GameSettingsPage {
	void makeSettings() {
		...
		Occurance(locale::NG_REMNANT_OCCURANCE, "REMNANT_OCCURANCE", max=5.0, tooltip=locale::NGTT_REMNANT_OCCURANCE);
		Occurance(locale::NG_ASTEROID_OCCURANCE, "ASTEROID_OCCURANCE", max=5.0);
		Occurance(locale::NG_RESOURCE_ASTEROID_OCCURANCE, "RESOURCE_ASTEROID_OCCURANCE", max=5.0);
