...
enum PlanetGfxAddon {
	...
	// Setting the DysonSphere planet graphics sets a flag of 4 for some reason
	// perhaps 0x4 is just the next bit flag after 0x2?
	PGA_DysonSphere = 0x4,
	// [[ MODIFY BASE GAME END ]]
}

// [[ MODIFY BASE GAME START ]]
array<string> PlanetGfxNames = {"SpaceElevator", "Ringworld", "DysonSphere"};
// [[ MODIFY BASE GAME END ]]
