...
void loadArtifacts(const string& filename) {
	...
	while(file++) {
		...
		// [[ MODIFY BASE GAME START ]]
		else if(key.equals_nocase("Ignored By Gravitars")) {
			type.ignoredByGravitars = toBool(value);
		}
		// [[ MODIFY BASE GAME END ]]
...
// [[ MODIFY BASE GAME START ]]
// TODO split up the distributed artifact logic so deep space artifacts
// have a seperate pool to the normal ones
// For now I am just creating all deep space artifacts with a frequency of 0
// [[ MODIFY BASE GAME END ]]
